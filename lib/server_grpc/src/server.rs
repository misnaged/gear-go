...
use crate::sign_transaction::polkadot_transfer_demo;
...
#[derive(Debug, Default)]
 ...
 impl GearGrpcService for MyGearGrpcService {
     async fn call_voucher_issue(
         ...
         let encoded_call = polkadot_transfer_demo(&*params.spender, &*params.balance, params.code_uploading, params.duration as u32);
